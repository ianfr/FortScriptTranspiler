...
# Addition from @https://github.com/ianfr
if __name__=="__main__":
    # See https://github.com/pyccel/pyccel-benchmarks/blob/9867762ce408d396bd694b3860321d40dc3ee6f6/benchmarks/run_benchmarks.py#L131
    p, k = md(3, 1000, 200, 0.1)
